...
const HomeFooter = () => {
    return (
        <div>
            <div className="priceBg xl:px-32 lg:px-24 md:px-20 px-5 md:py-20 py-10">
                <div className="flex justify-between items-center flex-wrap gap-4 lg:gap-0 md:text-[14px] text-[12px] text-white">
